...
export const wordLists: WordLists = {
  Hayvanlar: {
    1: ["KEDİ", "KUŞ", "FIL", "ALEV", "ASLAN", "ZEBRA", "OKAPI", "ÇİTA", "LEMUR", "TAPIR", "FLAM", "PENGUEN", "ORANG", "GORİL", "ŞEMP", "BABUN", "MAND", "TARS", "MARM", "TAMA", "HOWL", "SPID", "WOOL", "CAPU", "MACA", "GIBB", "LANG", "PROB", "COLO", "VERV", "GUEN", "DRILL", "GELA", "PATA", "MANG", "KÖPEK", "TAVŞAN", "SINCAP", "HAMSTER", "FARE", "PAPAĞAN", "KARTAL", "ŞAHİN", "BAYKUŞ", "KARGA", "DOĞAN", "GEYIK", "PANDA", "ÇAKAL"], // Kolay - 3+ harf  
  ...
  Yiyecek: {
    1: ["SÜT", "BAL", "TUZ", "YAĞ", "KEK", "NAN", "ÇAY", "SUP", "PEYNİR", "KAŞAR", "BEYAZ", "ÇEDAR", "MOZZA", "GOUDA", "BRIE", "EMMEN", "GRUYER", "PARME", "FETA", "RİÇO", "MASKO", "COTTAGE", "CREAM", "TAZE", "YOĞURT", "KEFİR", "AYRAN", "CACIK", "HAYDA", "ACUKA", "SALÇA", "REÇEL", "MARM", "PEKMEZ", "SUSHI", "RISO", "LAZA", "MAKARNA", "PİZZA", "PİDE", "DÖNER", "KEBAP", "KÖFTE", "BÖREK", "MANTİ", "DOLMA", "PASTA", "EKMEK", "ÇORBA"], // Kolay - 3+ harf
  ...
  Bilim: {
    1: ["ATOM", "GÜNEŞ", "YILDIZ", "LASER", "RADAR", "ÇEKİM", "ENERJİ", "DALGA", "FOTON", "GAMMA", "KUANTUM", "PARÇACIK", "NÖTRON", "ELEKTRON", "PROTON", "MOLEKÜL", "HÜCRESİ", "KROMOZOM", "MİTOZ", "MEİOZ", "OSMOZ", "ENZYM", "HORMON", "VİTAMİN", "MİNERAL", "KARBOHİDRAT", "PROTEİN", "AMINO", "GLİKOZ", "FRUKTOZ", "GALAKTOZ", "SUKROZ", "LAKTOZ", "MALTOZ", "SELÜLOZ", "NİŞASTA", "GLİKOJEN", "LİPİT", "STEROL", "FOSFO", "TRİGLİSERİT", "KOLESTERİN", "MEMBRAN", "NÜKLEİK", "BİYOTEK", "NANOTEK", "ASTROFI", "TERMODI", "ELEKTROM"], // Kolay - 3+ harf
  ...
  Ülkeler: {
    1: ["TÜRKİYE", "İTALYA", "FRANSA", "JAPONYA", "ÇİN", "ALMANYA", "İNGİLTERE", "RUSYA", "HİNDİSTAN", "YUNANISTAN", "BREZİLYA", "AVUSTRALYA", "ARJANTİN", "ENDONEZYA", "GÜNEY", "LÜKSEMBURG", "LİHTEN", "MARKO", "VATİKAN", "MONTE", "NORVEÇ", "İSVEÇ", "FİNLANDİYA", "DANİMARKA", "POLONYA", "ÇEKYA", "SLOVAKYA", "MACARİSTAN", "ROMANYA", "BULGARİSTAN", "HİRVATİSTAN", "SLOVENİYA", "ESTONYA", "LETONYA", "LİTVANYA", "İRLANDA", "MALTA", "KIBRIS", "ANDORA", "MONAKO", "İZLANDA", "UKRAYNA", "BELARUS", "MOLDOVA", "GÜRCİSTAN", "ERMENİSTAN", "AZERBAYCAN", "KAZAKİSTAN", "KIRGIZİSTAN"], // Kolay - 3+ harf
  ...
  Meslekler: {
    1: ["DOKTOR", "HEMŞİRE", "POLİS", "AŞÇI", "ÇİFTÇİ", "AVUKAT", "HAKİM", "PİLOT", "ASKER", "İTFAİYECİ", "MİMAR", "MÜHENDİS", "ECZACI", "DİŞÇİ", "VETERİNER", "PSİKİYATRİST", "NÖROLOJİ", "DERMATOLOJI", "KARDİYOLOJİ", "GASTROENTEROLOJI", "JİNEKOLOJİ", "EBE", "DİYETİSYEN", "FİZYOTERAPİST", "ODYOLOJI", "GÖZDOKTORU", "KULAKBURUN", "ÜROLOJİ", "ORTOPEDİ", "PLASTİK", "ANESTEZİYOLOJİ", "RADYOLOJİ", "PATOLOJİ", "NÜKLEER", "JERİATRİ", "ONKOLOJİ", "NEFROLOJİ", "ENDOKRİN", "METABOLİZMA", "İMMÜNOLOJİ", "ALERJİ", "RÖMATOLOJİ", "ENFEKSİYON", "GERİATRİ", "PEDİATRİ", "ÇOCUK", "YAŞLI", "HASTA", "SAĞLIK"], // Kolay - 3+ harf
