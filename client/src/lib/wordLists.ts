...
export const wordLists: WordLists = {
  Hayvanlar: {
    1: ["AT", "ARI", "KEDİ", "KUŞ", "FARE", "EŞEK", "KAZ", "KEÇİ", "İNEK", "BALIK", "KÖPEK", "KOYUN", "TAVUK", "ÖRDEK", "HOROZ", "DOMUZ", "SİNEK", "TAVŞAN", "SİNCAP", "CİVCİV", "HİNDİ", "KELEBEK", "KARINCA", "KURBAĞA", "ÖRÜMCEK"], // Kolay - 3-8 harf  
  ...
  Yiyecek: {
    1: ["SU", "BAL", "TUZ", "ÇAY", "MUZ", "ELMA", "ARMUT", "EKMEK", "SOĞAN", "SÜT", "KİRAZ", "ÜZÜM", "LİMON", "ÇİLEK", "HAVUÇ", "KAHVE", "ŞEKER", "PEYNİR", "ZEYTİN", "DOMATES", "PATATES", "YUMURTA", "MAKARNA", "PORTAKAL", "SALATALIK"], // Kolay - 2-10 harf
  ...
  Bilim: {
    1: ["SU", "ISI", "SES", "GEN", "DNA", "BAZ", "ATOM", "HAVA", "YASA", "SAYI", "UZAY", "ATEŞ", "IŞIK", "CANLI", "DENEY", "DOĞA", "KRAL", "RAKAM", "TEORİ", "BİLİM", "DALGA", "FOSİL", "GÜNEŞ", "HÜCRE", "ASİT"], // Kolay - 2-6 harf
  ...
  Markalar: {
    1: ["LG", "BMW", "HP", "IBM", "SAP", "CAT", "3M", "ARM", "BIC", "NIKE", "PUMA", "FORD", "SONY", "JEEP", "IKEA", "ZARA", "LEGO", "LAYS", "GUCCI", "PRADA", "TESLA", "INTEL", "NESTLE", "PHILIPS", "MİGROS"], // Kolay - 2-7 harf
  ...
  Spor: {
    1: ["F1", "BMX", "BOKS", "GOLF", "JUDO", "KANO", "KOŞU", "POLO", "SÖRF", "DART", "HOKEY", "KAYAK", "KÜREK", "YELKEN", "GÜREŞ", "HALTER", "RUGBY", "TENİS", "YÜZME", "BOCCE", "FUTBOL", "KRİKET", "BEYZBOL", "SQUASH", "BOWLING"], // Kolay - 2-7 harf
  ...
  "Film/TV": {
    1: ["UP", "ET", "CSI", "NCIS", "LOST", "HULK", "NEMO", "COCO", "DARK", "JAWS", "OZARK", "FARGO", "ROCKY", "ALIEN", "BONES", "HOUSE", "SUITS", "RAMBO", "SHREK", "MOANA", "BRAVE", "DEXTER", "LUPIN", "AVATAR", "BATMAN"], // Kolay - 2-6 harf
