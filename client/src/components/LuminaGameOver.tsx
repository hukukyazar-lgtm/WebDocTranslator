...
export const LuminaGameOver = memo(({ gameSuccess, score, word, timeLeft, streak, category, sequentialCount = 0, totalCorrect = 0, bestSequential = 0, onContinue, onPlayAgain, onMainMenu, completedWords = 0, totalWords = 50 }: LuminaGameOverProps) => {
  const gameResult = {
    isWin: gameSuccess,
    score: score,
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                {[
                  ...
                  { icon: Zap, value: bestSequential, label: "En Yüksek Sıralı", color: "#4ECDC4", bgColor: "#E5F9F7" }
                ].map((stat, index) => {
